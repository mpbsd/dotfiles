...
autocmd BufWritePre *.ledger  :call mpbsd#remove_trailing_spaces()
...
augroup mpbsd_ledger
  autocmd!
  autocmd BufWritePre *.ledger g/BRL$/:silent s/\s*,\s*/:/ge
  autocmd BufWritePre *.ledger g/BRL$/:silent call mpbsd#format_ledger_file()
augroup END
